...
$no = 1;
$id = $_GET['id'];
$sql = $conn -> query("SELECT * FROM supplier WHERE idsupplier = '$id'");
$d = $sql -> fetch_array();
?>
<html>
<head>
...
<form action="" method="post">
		<table class="table">
            ...
            <tr>
				<td>Telp Supplier</td>
				<td><input type="txt" class="form-control" name="tgl" value="<?php echo $d['3'] ?>"></td>
			</tr>
			<tr>
			<tr>
				<td></td>
...
$conn -> query("UPDATE supplier SET namasupplier = '$b',
                                  alamatsupplier = '$c',
                                  telpsupplier = '$d'
                                  WHERE idsupplier = '$a'");
