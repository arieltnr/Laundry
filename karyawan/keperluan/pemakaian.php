...
include'../../config.php';
$no = 1;
$a = $conn -> query("SELECT * FROM barang");
?>
<html>
<head>
				...
				<div class="modal-body">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nama">Nama Barang:</label>
                       <div class="col-sm-5">
                           <select class="form-control" name="a"><?php while($s = $a -> fetch_array()){ ?>
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nama">Jumlah Pakai:</label>
                      <div class="col-sm-5">
...
<div class="col-md-10">
   <nav class="a navbar navbar-default">
	...
	<div class="navbar-header">
	<ul class="nav navbar-nav navbar-right">
		<li class="active"><a href="pemakaian.php">Pemakaian Barang</a></li>
...
<?php
$tampil= $conn -> query("SELECT * FROM pemakaianbarang JOIN barang USING(kodebarang)");
...
if(isset($_POST['kirim'])){
    ...
    $conn -> query("INSERT INTO pemakaianbarang VALUES('', '$a', '$b')");
    $conn -> query("UPDATE barang set stok = stok - '$b' WHERE kodebarang = '$a'");
