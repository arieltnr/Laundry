              ...
              <form action="" method="post" class="form-horizontal">
				<div class="modal-body">
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nama">ID Supplier:</label>
                       <div class="col-sm-5">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nama">Alamat Supplier:</label>
                       <div class="col-sm-5">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-2" for="nama">Telp Supplier:</label>
                       <div class="col-sm-5">
                       <input type="txt" class="form-control" name="d">
                       </div>
                     </div>
				</div>
				<div class="modal-footer">
...
<?php
$tampil= $conn -> query("SELECT * FROM supplier");
...
while($data = $tampil -> fetch_array()){   ?>
    ...
    <tr>
      ...
      <td>
           <a class="btn btn-success" href="suppliered.php?id=<?php echo $data['0']; ?>"><span class="glyphicon glyphicon-pencil"></span></a> 
           <a class="btn btn-danger" href="supplierha.php?id=<?php echo $data['0']; ?>" onclick="return confirm('Hapus')"><span class="glyphicon glyphicon-trash"></span></a>
       </td>
<?php } ?>
</table>
    <?php  
...
$conn -> query("INSERT INTO supplier VALUES('$a', '$b', '$c', '$d')");
