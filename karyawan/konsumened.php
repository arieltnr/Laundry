...
$id = $_GET['id'];
$no = 1;
$sql = $conn -> query("SELECT * FROM konsumen WHERE kodekonsumen = '$id'");
$d = $sql -> fetch_array();
?>
<html>
<head>
...
<div class=".navbar-custom"></div>
	...
	<div class="col-md-10">
        <h3><span class="glyphicon glyphicon-user"></span>  Edit Data Konsumen</h3>
        <a class="btn" href="konsumen.php"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>

<form action="" method="post">
		<table class="table">
			<tr>
				<td></td>
				<td><input type="hidden" name="id" value="<?php echo $d['0'] ?>"></td>
			</tr>
			<tr>
				<td>Nama</td>
			...
			<tr>
				<td>Alamat</td>
				<td><textarea class="form-control" name="alm"><?php echo $d['2'] ?></textarea></td>
			</tr>
			<tr>
				<td>NO HP</td>
				<td><input type="text" class="form-control" name="hp" value="<?php echo $d['3'] ?>"></td>
			</tr>
			<tr>
				<td></td>
...
$conn -> query("UPDATE konsumen SET namakonsumen = '$b',
                                    almtkonsumen = '$c',
                                    hpkonsumen = '$d'
                                    WHERE kodekonsumen = '$a'");
